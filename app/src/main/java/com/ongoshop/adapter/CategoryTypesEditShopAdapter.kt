...
import com.ongoshop.activities.MyShopEditActivity
import com.ongoshop.pojo.CategoryListResponse
import com.ongoshop.utils.helperclasses.CategoryTypesClicklisetener


class CategoryTypesEditShopAdapter(
    val context: Context?,
    internal var getTypesOfCategoryList: ArrayList<CategoryListResponse.Body>,
    internal var myShopEditActivity: MyShopEditActivity, internal var categoryTypesClicklisetener: CategoryTypesClicklisetener
) : RecyclerView.Adapter<CategoryTypesEditShopAdapter.CategoryTypesHomeHolder>() {
